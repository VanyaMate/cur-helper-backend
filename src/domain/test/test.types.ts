...
/**
 * Тип который показывает статус теста
 */
...
/**
 * Тип который показывает результаты и статус теста
...
/**
 * Тип который нужен для прохождения теста
 */
...
/**
 * Тип, который нужен чтобы показать результаты теста
 */
